...
def test_gerar_senha_tamanho_invalido():
    """Testa se o programa bloqueia a criação de senhas com tamanho zero ou negativo"""
    with pytest.raises(ValueError, match="O tamanho da senha deve ser maior que zero"):
        gerar_senha(0)
